#!/usr/bin/env python3
"""
Unit tests for rollout_metrics.py — no slime, no Modal, no SGLang.
...
Run from slime repo root:
  python examples/qwen3-235b_fullasync_swe-env/tests/test_rollout_metrics.py
"""
...
import rollout_metrics as asm  # noqa: E402
