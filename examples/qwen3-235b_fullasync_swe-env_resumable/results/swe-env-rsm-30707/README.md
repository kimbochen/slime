# swe-env-rsm-30707 — 12-node resumable SWE-bench run
...
- **`add_slime_metrics.py:157` policy_staleness stamp** — overwrites the
...
├── add_slime_metrics.py                # unchanged from base example
